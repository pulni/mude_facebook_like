    ...
    <tr>
      ...
      <td valign="top" class="edittext">
        ...
        <table cellspacing="0" cellpadding="0" border="0">
          ...
          [{* BEGIN MUDE_FACEBOOK_LIKE *}]
            <tr>
              <td class="edittext" width="120">
                [{ oxmultilang ident="MUDE_FACEBOOK_LIKE_SHOW_BUTTON" }]
              </td>
              <td class="edittext">
                <input class="edittext" type="hidden" name="editval[oxarticles__mude_show_facebook_like_button]" value='0'>
                <input class="edittext" type="checkbox" name="editval[oxarticles__mude_show_facebook_like_button]" value='1' [{if $edit->oxarticles__mude_show_facebook_like_button->value == 1}]checked[{/if}] [{ $readonly }]>
              </td>
            </tr>
            [{* END MUDE_FACEBOOK_LIKE *}]
          <tr>
            <td class="edittext">
